        ...
        class BasicThread implements Runnable {
            ...
            public void run() {
                try {
                    ...
                    // Functions.sendMessage(player, Color.DARK_AQUA + "Website: " + Color.WHITE + "discord.gg/ecx");

                    // Functions.sendMessage(player, Color.DARK_AQUA + Phrase.build(Phrase.LINK_DISCORD, Color.WHITE + "discord.gg/ecx").replaceFirst(":", ":" + Color.WHITE));
                    Chat.sendMessage(player, Color.DARK_AQUA + Phrase.build(Phrase.LINK_DISCORD, Color.WHITE, "discord.gg/ecx"));
                }
                catch (Exception e) {
                    e.printStackTrace();
                }
